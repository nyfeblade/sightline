...
#
# usage: scripts/demo.sh [fixture-dir]    then: CLAUDE_CONFIG_DIR=<dir> Sightline
set -euo pipefail

FIXTURE="${1:-/tmp/sightline-fixture}"
REPO=/tmp/sightline-demo-repo
...
echo "repo:     $REPO"
echo "run:      CLAUDE_CONFIG_DIR=$FIXTURE Sightline --since 30d"
