...
bin="$root/target/release/ironsight-gui"
...
mkdir -p "$apps"
cat > "$apps/ironsight.desktop" <<EOF
[Desktop Entry]
Type=Application
Version=1.0
Name=Ironsight
...
echo "Ironsight is in your application menu · terminal view: $root/target/release/ironsight"
